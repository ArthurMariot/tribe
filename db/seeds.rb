...
julien = User.create!(email: "julien@zapier.com", password: "password", first_name: "Julien", last_name: "Perrault", company: zapier, team: sales, hierarchy_rank: head, location: "San Francisco", remote_avatar_url: "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcT8VJoMjKiEHU0v2LGEwp_tENAXtmLeLctr9cFoNsNn0LkuuZZf", hobby_1: "Heavy Metal", hobby_2: "Swimming", hobby_3: "Judo", job_title: "B2B sales leader")
edouard = User.create!(email: "edouard@zapier.com", password: "password", first_name: "Edouard", last_name: "Uguen", company: zapier, team: design, hierarchy_rank: junior, onboarding_status: true, buddy: caroline, location: "Marseille", remote_avatar_url: "https://d3qi0qp55mx5f5.cloudfront.net/computerscience/i/people/gordon-headshot.jpeg?mtime=1560268963", remote_contract_pdf_url: "https://www.simplybusiness.co.uk/media/legal-documents/downloads/pdf/contract-of-employment-template-free-download.pdf", remote_rules_reglementation_pdf_url: "https://www.ivpc.com/docs/regEng.pdf", hobby_1: "Archeology", hobby_2: "Egypt", hobby_3: "Pets", job_title: "Sales manager")
